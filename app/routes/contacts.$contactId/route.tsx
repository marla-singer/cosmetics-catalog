...
export const loader = async ({ params }: LoaderFunctionArgs) => {
  // property name on the params object maps directly to the name of your file (contacts.$contactId => params.contactId)
...
// this action binds to Form method="post"
...
const Favorite: FunctionComponent<{
  ...
  // use it to change the data on the page without causing a navigation
